...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of VerticalCardSwitcher.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kruljac.matija@gmail.com/VerticalCardSwitcher'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kruljac.matija@gmail.com' => 'kruljac.matija@gmail.com' }
  s.source           = { :git => 'https://github.com/kruljac.matija@gmail.com/VerticalCardSwitcher.git', :tag => s.version.to_s }
